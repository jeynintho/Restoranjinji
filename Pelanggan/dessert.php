...
<body>
  ...
  <!-- Hero Section -->
  <section class="hero">
    <img src="img/dessert3.jpg" alt="Kayumanis Dish" class="hero-img">
  </section>

  <section class="menu-section">
    <h2 class="menu-title">DESSERT MENU</h2>
    <h4 class="menu-subtitle">Check Our Tasty Menu</h4>

    <div class="menu-items">
      <?php
      $query = mysqli_query($conn, "SELECT * FROM menu WHERE jenis = 'Makanan Ringan' AND tersedia = 1");
